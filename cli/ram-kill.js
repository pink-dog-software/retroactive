...
const ramKiller = () => {
  const command = `kill $(ps aux | grep '[.]/node_modules/.bin/webpack-dev-server --mode development --open --hot --port 8080' | awk '{print $2}'); kill $(ps aux | grep '[n]ode ./server/app.js' | awk '{print $2}'); docker container stop retrodb`
  console.log(`Executing ${command}`)
